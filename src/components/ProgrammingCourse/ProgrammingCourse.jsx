    ...
    return (
        <div className="ml-12 mr-12 mt-10">
            ...
            <div className="flex justify-between items-center" >
                ...
                <div className="text-xl">
                    <p>{readTime} min read <span className="ml-1 hover:text-green-600">< FontAwesomeIcon onClick={() => handleAddToBookMark(props.programmingCourse)} icon={faBookmark} /></span>
                    </p>
                </div>
            </div>
            <h1 className="text-5xl font-semibold mb-2">{blogTitle}</h1>
            <h4 className="text-xl font-semibold text-[#11111199]"> #beginners #programming</h4>
            <h4 className="text-xl font-semibold hover:text-violet-600 hover:underline p-2" onClick={() => handleMarkAsRead(props.programmingCourse, id)} >Mark as Read</h4>
        </div>
    );
};
